...
public class Program
{
    ...
    static int n_step_m(int n, int m){
      int close = m;
      int close_step = 1;
      int step = 1;// n -число m - степень
      while (close >= n){
        close *= m;
      }
    ...
    {
        /* int m = int.Parse(Console.ReadLine());        int n = int.Parse(Console.ReadLine());
...
/*        int a = int.Parse(Console.ReadLine());
      ...
      Console.WriteLine($"{n_step_m(m,n)}");
        /*
        int m = int.Parse(Console.ReadLine());
        int n = int.Parse(Console.ReadLine());
        fath_son(m,n);
